...
description: Memastikan semua proyek (baru/lama) ditanyakan untuk mengadopsi Model Kerja v9.0 jika belum memiliki konfigurasi AGENTS.md.
trigger: always_on
---

<system_directive>
# GLOBAL COMPLIANCE CHECKER (Auto-Enforce Model Kerja v9.0)
...
2. **Kondisi A (Aturan Lokal Ditemukan)**:
   Jika `AGENTS.md` ada, maka Anda **WAJIB** membaca dan mematuhi aturan tersebut secara ketat (beserta `working.md`). Terapkan disiplin otonomi, *Goal-Pursuing*, *Self-Healing*, dan *Zero-Regression* v9.0.
...
3. **Kondisi B (Aturan Lokal TIDAK Ditemukan / Proyek Lama/Baru)**:
   ...
   > "⚠️ **Peringatan Kepatuhan Sistem**: Proyek ini belum mengadopsi **Model Kerja v9.0 Autonomous & Strict Compliance**. 
